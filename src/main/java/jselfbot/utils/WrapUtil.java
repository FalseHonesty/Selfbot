...
public class WrapUtil {
     ...
     * https://mvnrepository.com/artifact/org.apache.commons/commons-lang3  * cr, lf, or cr lf. A line ending at the end of the string will not output a
    ...
    public static ArrayList<String> splitStringByLength(String input, int length) {
        ArrayList<String> strings = new ArrayList<String>();
        int index = 0;

        while (index < input.length()) {
            strings.add(input.substring(index, Math.min(index + length, input.length())));
            index += length;
        }
